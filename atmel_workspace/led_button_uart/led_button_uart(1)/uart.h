...
//volatile uint8_t serial_reveived_bytes_counter = 0;
//volatile uint8_t total_bytes = 0;
//
//#define SERIAL_BUF_SIZE 200
//
//// RX and TX buffers
//volatile uint8_t rx_buffer[SERIAL_BUF_SIZE] = {0};
//volatile uint8_t tx_buffer[SERIAL_BUF_SIZE + 14] = "Your message: ";
